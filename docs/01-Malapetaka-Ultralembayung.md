...
Dengan membandingkan pers. \@ref(eq:mu-25) dengan hukum Stefan&ndash;Boltzmann, maka kita menerka perhubungan ini,
$$\sigma T^4 \stackrel{?}{=} \frac{8\pi^5 k_B^4}{15h^3c^3}T^4,$$
tetapi terkaan ini tidak benar kerana jika kita kira setiap satu pemalar tersebut, kita akan dapati nilainya tidak sama dengan pemalar Stefan&ndash;Boltzmann, $\sigma$,
\begin{align*}
...
**USUL 1**: Hukum Rayleigh&ndash;Jeans boleh diperoleh jika dihadkan panjang gelombang menghampiri infiniti dalam hukum Planck,
\begin{equation}
