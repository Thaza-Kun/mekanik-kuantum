...
Suatu sistem kuantum boleh diungkapkan sebagai hasil tambah dua atau lebih fungsi-fungsi keadaan kuantumnya,
$$|\Psi\rangle = A|\psi_1\rangle + B|\psi_2\rangle + \cdots.$$
Perhatikan persamaan prinsip ini dengan prinsip \@ref(lem:lem-fg-01) berkaitan superposisi gelombang. Makna kurungan $|\psi\rangle$ akan diperkenalkan kemudian.
```
