...
### Kaedah Memperoleh Hukum Stefan&ndash;Boltzmann Daripada Hukum Planck
...
Jika kalian pernah gelintar sekitar Google, kalian akan dapati bahawa terdapat persamaan-persamaan Planck yang berbeza bentuknya. Khususnya, ada yang menyatakan bahawa pekalinya mendarab $2$, $2\pi$, dan bukannya $8\pi$ seperti yang digunakan dalam nota ini. Setiap satunya betul dan ada perbezaan yang halus.
\begin{enumerate}\margintext{Rujuk \citet{Webeneger_tt} untuk maklumat lanjut.}
  \item Dalam bentuk kesinaran, persamaan Planck ialah $$L=\frac{2 hc^2}{\lambda^5}\frac{1}{e^{\frac{hc}{\lambda k_BT}}-1}.$$
  \item Dalam bentuk ketumpatan fluks, persamaan Planck ialah $$M=\frac{2\pi hc^2}{\lambda^5}\frac{1}{e^{\frac{hc}{\lambda k_BT}}-1}.$$
  \item Dalam bentuk ketumpatan tenaga pula, $$U=\frac{8\pi hc}{\lambda^5}\frac{1}{e^{\frac{hc}{\lambda k_BT}}-1}.$$
\end{enumerate}

Dari segi pemahaman sinaran jasad hitam dan pentafisran bentuk graf, ketiga-tiga bentuk ini tiada bezanya. Masing-masing adalah fungsi yang sama dengan pekali yang berbeza-beza. Oleh itu, kadang-kadang istilah kesinaran digunakan. Kadang-kadang fluks digunakan. Kadang-kadang ada pula yang gunakan keamatan.

Namun, perbezaannya muncul kerana setiap satunya mempunyai takrifan tepat yang berbeza. Jadinya, apabila persamaan ini hendak ditukarkan menjadi persamaan lain, tukang tukarnya perlu teliti. Misalnya dalam pemerolehan hukum Stefann--Boltzmann dalam bahagian \ref{bahagian:STBP}, bentuk yang kita gunakan memerlukan kita mendarab dengan $\frac{c}{4}$. Jika kita gunakan bentuk kedua iaitu ketumpatan fluks, kita tidak perlu mendarab dengan pekali tersebut.

Satu-satunya sebab saya menggunakan bentuk ketiga dalam nota ini ialah kerana kuliah saya menggunakan bentuk ini sepenuhnya. Hasilnya, hukum-hukum lain seperti Hukum Taburan Wien dan Hukum Rayleigh--Jeans juga diperoleh dalam bentuk ketumpatan tenaganya. Hukum Sesaran Wien pula tidak merasakan perbezaan ini kerana pekali tersebut tidak memainkan peranan apabila ditetapkan $\dv{\lambda}f = 0$.