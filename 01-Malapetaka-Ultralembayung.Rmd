...
Dalam jujukan $a, ax, ax^2, ax^3,...,ax^N$ setiap sebutan seterusnya didarabkan dengan $x$. Penjumlahan setiap sebutan dalam jujukan ini ialah sirinya. Jika $-1<x<1$ dan $N\to\infty$, maka siri geometrinya adalah begini,
$$\lim_{N\to\infty}\sum_{n=0}^N ax^n = a\frac{1}{1-x}.$$
```
```{theorem mu-thm-02, name="Pembezaan Siri Geometri"}
**Contoh 12.18, \citet{Mayer2006}**
