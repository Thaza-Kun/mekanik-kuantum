...
from scripts.blackbody import Wien
from scripts.graphing import blackbody_by_wavelength

blackbody_by_wavelength(models=[(Wien, None)], title='Lengkung sinaran jasad hitam berdasarkan model Wien', mock_data='data contoh')
```
