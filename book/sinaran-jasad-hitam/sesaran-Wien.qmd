...
Saya merujuk kepada nilai yang diperoleh oleh [@Stroyan1998]^[[@Stroyan1998] menulisnya sebagai $5=(5-X)e^X$ tetapi bentuk ini setara dengan $X\frac{e^X}{e^X-1} = 5$.], iaitu $X \approx 4.9651$.
